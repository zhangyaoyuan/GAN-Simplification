...
${PERL} ${MOSES_CLEAN} corpus en et "corpus.clean" 1 250

${PYTHON} ${VOCAB_SKRIPT} --max_vocab_size 50000 < corpus.clean.en > vocab.50k.en
${PYTHON} ${VOCAB_SKRIPT} --max_vocab_size 50000 < corpus.clean.et > vocab.50k.et

# Learn Shared BPE
for merge_ops in 32000; do
  echo "Learning BPE with merge_ops=${merge_ops}. This may take a while..."
  cat "corpus.clean.en" "corpus.clean.et" | \
  ...
  cat "corpus.clean.bpe.32000.en" "corpus.clean.bpe.32000.et" | \
