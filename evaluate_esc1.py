...
class Evaluator(object):
    ...
    def translate(self):
        ...
        logging.info('5.Translate : prepare_data_esc/test.8turkers.clean.src !!!!')
        fd = codecs.open(self.out_file, 'w', 'utf8')
        count = 1
        start = time.time()
        for X in self.du.get_test_batches(set_src_path="prepare_data_esc/test.8turkers.clean.src.big",set_batch=64):
            # Beam Search !!
        ...
        #output="prepare_data_esc/good_test_clean.tmp.out"
        #source=config.test.src_path
        #target=[config.test.dst_path]
        source = "prepare_data_esc/test.8turkers.clean.src"
        target = ["prepare_data_esc/test.8turkers0.clean.dst","prepare_data_esc/test.8turkers1.clean.dst","prepare_data_esc/test.8turkers2.clean.dst","prepare_data_esc/test.8turkers3.clean.dst","prepare_data_esc/test.8turkers4.clean.dst","prepare_data_esc/test.8turkers5.clean.dst","prepare_data_esc/test.8turkers6.clean.dst","prepare_data_esc/test.8turkers7.clean.dst","prepare_data_esc/test.8turkers.clean.dst"]
