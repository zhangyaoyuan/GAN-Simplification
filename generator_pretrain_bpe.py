...
from evaluate_bpe0 import Evaluator #!!!
    ...
    for epoch in range(1, config.train.num_epochs+1):
        for batch in du.get_training_batches_with_buckets():
            ...
            if step % config.train.save_freq == 0:
                ...
                target=[config.test.ori_dst_path]
                ...
                #output_t = "data/test.8turkers.tok.out"
                ...
                SARI,BLEU = process_evaluation_file_multi(source, output, target)
